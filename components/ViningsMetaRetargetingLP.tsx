...
import {
  ...
  PHONE_HAIR, PHONE_HAIR_HREF, EMAIL, ADDRESS, LOGO_ICON, WORDMARK,
} from '@/lib/brand'

// Faithful recreation of the Vinings Hair Meta *retargeting* landing pages:
//   start.colgrove.com/meta-retargeting/        -> variant "standard"
//   start.colgrove.com/meta-retargeting-artas/  -> variant "artas"
// Warm-audience variants with the extra Best-For/Not-ideal, "why now", four
// patient testimonials, two objection blocks, a candidacy / Why-ARTAS block, a
// what-happens-next timeline, and a medical-decision block. Copy reproduced
// verbatim from source (Joe waived Meta ad-policy softening). HIPAA carve-out:
// no browser Meta pixel on these health-intent form pages. ARTAS® manufacturer
// attribution (Venus Concept) kept verbatim; no added device claims.

const LIGHT_BTN_BG = '#f2ead6'
...
export default function ViningsMetaRetargetingLP({ heroFormId, bottomFormId, variant = 'standard' }: Props) {
  ...
  const heroSub = artas
    ...
    : 'Vinings hair restoration protects your donor area and plans for natural-looking results—based on your hair loss pattern.'

  const testimonials = artas
    ? [
        { name: 'David L.', text: 'The team made me feel comfortable from day one. They explained every step of the process and the results have been life-changing. Highly recommend their services.' },
        { name: 'Power F.', text: 'Dr. Colgrove and his staff were very welcoming, warm and friendly. They answered my questions and exceeded my expectations.' },
        { name: 'Ajit', text: 'Dr. Colgrove is very professional and the staff are really amazing. I am very happy. It was a great experience.' },
        { name: 'BWPP', text: 'I was very happy with Vinings Surgery & Hair Restoration Center. The consultation was very informative. They went over all the steps before, during and after. I was also given a booklet which was helpful about the entire process. Overall I was very impressed with the staff and the performance. I strongly recommend Vinings Hair Restoration.' },
      ]
    : [
        { name: 'David L.', text: 'The team made me feel comfortable from day one. They explained every step of the process and the results have been life-changing. Highly recommend their services.' },
        { name: 'BWPP', text: 'I was very happy with Vinings Surgery & Hair Restoration Center. The consultation was very informative. They went over all the steps before, during and after. I was also given a booklet which was helpful about the entire process. Overall I was very impressed with the staff and the performance. I strongly recommend Vinings Hair Restoration.' },
        { name: 'Power F.', text: 'The team made me feel comfortable from day one. They explained every step of the process and the results have been life-changing. Highly recommend their services.' },
        { name: 'Ajit', text: 'Dr. Colgrove is very professional and the staff are really amazing. I am very happy. It was a great experience.' },
      ]
    ...
    <>
      ...
      <header className="site-header" style={{
        ...
        <div className="site-header-logo" style={{ display: 'flex', alignItems: 'center' }}>
          <img src={LOGO_ICON} alt="VSC" height={40} />
          <span className="logo-wordmark" style={{ color: '#fff', fontWeight: 700, fontSize: 14, letterSpacing: '0.02em', display: 'inline-flex', alignItems: 'center' }}>{WORDMARK}</span>
        </div>
        <div className="site-header-actions" style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
            <a href="#hero-form" className="header-cta" style={{
              background: GOLD, color: NAVY, fontWeight: 700, borderRadius: 24,
          ...
          <a className="phone-link" href={PHONE_HAIR_HREF} style={{ color: '#fff', fontWeight: 600, textDecoration: 'none' }}>
            {PHONE_HAIR}
          </a>
        </div>
      </header>
      ...
      <section ref={heroReveal.ref} className={heroReveal.className} style={{ background: NAVY, padding: '56px 24px 56px' }}>
        <div className="two-col" style={{ maxWidth: 1200, margin: '0 auto', alignItems: 'start', gap: 48 }}>
          <div>
            ...
            <img src="/img/m/rt-ba.webp" alt="Vinings hair restoration before and after" style={{ width: '100%', borderRadius: 16, display: 'block', marginBottom: 8 }} />
            <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.6)', margin: 0 }}>Actual Patient Results &middot; Individual results vary</p>
          </div>
      ...
      <section ref={compareReveal.ref} className={compareReveal.className} style={{ background: '#f1ede4', padding: '56px 24px' }}>
        <div className="two-col" style={{ maxWidth: 900, margin: '0 auto', gap: 20 }}>
          <div style={{ background: '#fff', border: `1px solid ${CARD_BORDER}`, borderRadius: 12, padding: '28px 26px', textAlign: 'center' }}>
        ...
        <p style={{ textAlign: 'center', fontSize: 14, color: '#6a7282', margin: '24px 0 0' }}>
          Not sure? <a href="#final-form" style={{ color: NAVY, fontWeight: 600, textDecoration: 'none' }}>Check candidacy &gt;</a>
        </p>
      </section>
        ...
        <div style={{ maxWidth: 1000, margin: '0 auto' }}>
          ...
          <div className="two-col" style={{ gap: 20, marginBottom: 36 }}>
            {[
              ...
              <div key={t} style={{ display: 'flex', gap: 14, alignItems: 'center', background: CARD_BG, border: `1px solid ${CARD_BORDER}`, borderRadius: 12, padding: '20px 22px' }}>
                <Check />
          ...
          <div style={{ textAlign: 'center' }}>
            <a href="#final-form" style={{ display: 'inline-block', background: NAVY, color: '#fff', padding: '15px 32px', borderRadius: 40, fontSize: 14, fontWeight: 700, textDecoration: 'none' }}>
              See If I&rsquo;m a Candidate
            </a>
          </div>
        </div>
      ...
      <section ref={testimonialsReveal.ref} className={testimonialsReveal.className} style={{ background: '#f5f6f8', padding: '64px 24px' }}>
        <div style={{ maxWidth: 1160, margin: '0 auto' }}>
          <h2 style={{ fontSize: 'clamp(24px, 3vw, 32px)', fontWeight: 800, color: HEADING, textAlign: 'center', margin: '0 0 8px', textTransform: 'uppercase' }}>
            Real Patients &mdash; Real Outcomes
          </h2>
          ...
          <div className="two-col" style={{ alignItems: 'stretch', gap: 20 }}>
            {testimonials.map((t, i) => (
              <div key={`${t.name}-${i}`} style={{ background: '#fff', border: `1px solid ${CARD_BORDER}`, borderRadius: 16, padding: '28px 26px', display: 'flex', flexDirection: 'column' }}>
      ...
      <section ref={shavingReveal.ref} className={shavingReveal.className} style={{ background: '#fff', padding: '64px 24px' }}>
        <div style={{ maxWidth: 820, margin: '0 auto' }}>
          ...
          <a href="#final-form" style={{ display: 'inline-block', background: NAVY, color: '#fff', padding: '14px 30px', borderRadius: 40, fontSize: 14, fontWeight: 700, textDecoration: 'none' }}>
      ...
      <section ref={candidateReveal.ref} className={candidateReveal.className} style={{ background: NAV_BG, padding: '64px 24px' }}>
      ...
      <section ref={nextReveal.ref} className={nextReveal.className} style={{ background: '#fff', padding: '64px 24px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div className="three-col" style={{ marginBottom: 28 }}>
            {[
              ['1', artas ? 'Review your hair loss pattern + donor supply' : 'A thorough consultation and hair evaluation'],
      ...
      <section ref={finalReveal.ref} className={finalReveal.className} style={{ background: '#fff', padding: '64px 24px' }}>
        <div className="two-col" style={{ maxWidth: 1050, margin: '0 auto', gap: 48, alignItems: 'center' }}>
          <div id="final-form" style={{ background: CARD_BG, border: `1px solid ${CARD_BORDER}`, borderRadius: 16, padding: '24px' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              <a href={PHONE_HAIR_HREF} style={{ color: HEADING, fontWeight: 600, fontSize: 15, textDecoration: 'none' }}>{PHONE_HAIR}</a>
      ...
      {/* Footer */}
      <footer style={{ background: NAV_BG, color: 'rgba(255,255,255,0.7)', padding: '40px 24px' }}>
        <div style={{ maxWidth: 1000, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 12, margin: 0 }}>&copy; 2026 Vinings Surgery. All rights reserved.</p>
        </div>
      </footer>
    </>
  )
